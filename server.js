...
app.get("/clock", (request, response) => {
  response.sendFile(__dirname + "/views/clock.html");
});

app.get("/psets", (request, response) => {
  response.sendFile(__dirname + "/views/psets.html");
});

app.get("/unit7", (request, response) => {
  response.sendFile(__dirname + "/views/unit7.html");
});
